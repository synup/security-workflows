...
SAMPLES = {
    ...
    "malware.atob_env":          'const u = atob(process.env.AUTH_API_KEY);',
    "malware.remote_eval":       'const r = await fetch(u); eval(await r.text());',
    "malware.eval_await":        'eval(await resp.text());',
